...
public class QueryApp {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("0. Find first matched document");
			...
			System.out.println("\n4. Find where number in 2,4 and 5");
			...
			System.out.println("\n7. Find when number = 2 and name = 'mkyong-2' example");
			...
			// love regular expression
			System.out.println("\n8. Find where name = 'Mky.*-[1-3]', case sensitive example");
